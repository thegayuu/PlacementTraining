...
if(isset($btn))
	{
			...
			$qry=mysql_query("select * from ss_register where uname='$uname' && pass='$pass'");
			$num=mysql_num_rows($qry);
				if($num==1)
				{
				mysql_query("delete from ss_temp where uid='$uname'");
				/////////////////
$dir=@opendir("../social_relation_face/comments");
while($file=readdir($dir))
{
@unlink("../social_relation_face/comments/$file");
}
    ...
    <tr>
      <td align="center" valign="top"><p class="txt1">&nbsp;</p>
        <table width="89%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><img src="images/complab001.jpg" width="340" height="220"></td>
            <td valign="top"><table width="318" height="169" border="0" cellpadding="5" cellspacing="0" class="bgbor">
                <tr>
                  <td colspan="2" align="center" class="txt1"><strong>Student Login</strong></td>
                </tr>
                <tr>
